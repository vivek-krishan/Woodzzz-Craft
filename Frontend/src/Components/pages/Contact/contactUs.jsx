...
const ContactUs = () => {
  ...
  const ContactForm = () => {
    ...
    return (
      <section className='Contact-Us w-1/2 text-gray-700 body-font  border border-black '>
            ...
            <div className='flex flex-wrap -m-2'>
              ...
              <div className='p-2 w-full'>
                <button
                  ...
                  className='flex mx-auto text-white bg-indigo-500 border-0 py-2 px-8 focus:outline-none hover:bg-indigo-600 rounded text-lg cursor-pointer transition duration-300 transform hover:scale-105'
                >
                  Submit
                </button>
              </div>
        ...
        >
          <h1 className='flex flex-col truncate justify-center items-start lg:px-5 font-semibold font-sans pt-5'>
            ...
            <span className='font-normal'>
              Near Kokar chowk, Ranchi - 834009
            </span>
          </h1>
          <motion.section
  ...
  return (
    <div>
      ...
      <section className='about-us bg-gradient-to-br from-orange-50 via-white to-indigo-50 text-gray-800 body-font py-20'>
        <div className='container mx-auto flex flex-col md:flex-row items-center px-5'>
          <div className='md:w-1/2 flex flex-col items-start text-left mb-16 md:mb-0'>
            ...
            <Link
              to='/shop'
              className='inline-block px-8 py-3 bg-[#EB5A2A] text-white rounded-full shadow-lg hover:bg-indigo-600 transition duration-300 font-semibold text-lg'
            >
          ...
          <div className='md:w-1/2 flex justify-center'>
            <div className='relative group'>
              <img
                className='object-cover object-center rounded-3xl shadow-2xl w-[400px] h-[420px] border-8 border-white group-hover:scale-105 transition-transform duration-300'
                alt='hero'
                src='https://ik.imagekit.io/woodzcraft/IMG_20250411_105210-removebg-preview.png?updatedAt=1744349111877'
              />
              <span className='absolute bottom-4 right-6 bg-[#EB5A2A] text-white px-4 py-2 rounded-full shadow-lg text-lg font-bold opacity-90'>
                100% Handcrafted
              </span>
            </div>
          </div>
      ...
      <section className='our-team bg-white text-gray-800 body-font border-t border-gray-200 py-20'>
        <div className='container px-5 mx-auto'>
          <div className='flex flex-col text-center w-full mb-16'>
            <h1 className='text-5xl font-bold title-font mb-4 text-indigo-700 font-Caveat drop-shadow'>
              Meet Our Team
            </h1>
          ...
          <div className='flex flex-wrap justify-center items-center gap-8'>
            <div className='p-4 lg:w-1/3 md:w-1/2 w-full'>
              <a
                target='_blank'
                rel='noopener noreferrer'
                className='h-full flex items-center border border-gray-200 p-6 rounded-2xl bg-gradient-to-br from-orange-100 to-white shadow-xl hover:scale-105 transition-transform duration-300'
              >
                <img
                  alt='team'
            ...
            <div className='p-4 lg:w-1/3 md:w-1/2 w-full'>
              <a
                ...
                target='_blank'
                rel='noopener noreferrer'
                className='h-full flex items-center border border-gray-200 p-6 rounded-2xl bg-gradient-to-br from-indigo-100 to-white shadow-xl hover:scale-105 transition-transform duration-300'
              >
                <img
                  alt='team'
                  className='w-20 h-20 bg-gray-100 object-cover object-center flex-shrink-0 rounded-full mr-6 border-4 border-indigo-400 shadow-md'
      ...
      <section className='founder-words bg-gradient-to-br from-indigo-50 via-white to-orange-50 text-gray-800 body-font border-t border-gray-200 py-20'>
        <div className='container px-5 mx-auto'>
      ...
      <section className='contact-form w-full flex items-center justify-between  border border-green-600'>
        <ContactForm />
        <span>Or</span>
