...
const ContactUs = () => {
  ...
  const ContactForm = () => {
    ...
    return (
      <section className="Contact-Us lg:w-1/2 text-gray-700 body-font ">
  ...
  return (
    <div>
      ...
      <section className="founder-words bg-gradient-to-br from-indigo-50 via-white to-orange-50 text-gray-800 body-font py-20">
        <div className="container px-5 mx-auto">
          <div className="xl:w-2/3 lg:w-3/4 w-full mx-auto text-center">
            ...
            <p className="leading-relaxed lg:text-xl italic text-gray-700 bg-white/80 p-8 rounded-2xl shadow-lg">
      ...
      <section className="contact-form w-full flex lg:flex-row flex-col items-center justify-center ">
        <ContactForm />
        {/* <span>Or</span> */}
